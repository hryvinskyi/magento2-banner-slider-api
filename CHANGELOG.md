...
### Added
- `CUSTOM_CSS` constant to `SliderInterface`
- `getCustomCss(): ?string` method to `SliderInterface`
- `setCustomCss(?string $customCss): SliderInterface` method to `SliderInterface`
